// Récupère le résultat d'une recherche d'actualité lancée en background.
// L'interface interroge cette fonction (polling) jusqu'à status "done".
...
export default async (req, context) => {
  ...
  try {
    ...
    if (!record) {
      // Pas encore écrit : le job vient d'être lancé.
